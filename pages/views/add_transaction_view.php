...
<div class="bg-white p-6 rounded-lg shadow-lg w-96 transition-transform transform hover:scale-105">
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Nieuwe Transactie</h2>
    <form method="post">

        <label class="block text-gray-700">Bedrag (€)</label>
        <input type="number" name="amount" step="0.01" min="0.01" class="w-full p-2 border rounded mb-3 focus:ring focus:ring-blue-200" required>
        ...
        <input type="text" name="category" class="w-full p-2 border rounded mb-3 focus:ring focus:ring-blue-200" required>

        <label class="block text-gray-700">Datum</label>
        <input type="date" name="date" class="w-full p-2 border rounded mb-3 focus:ring focus:ring-blue-200" required>

        <button type="submit" class="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition-all">Toevoegen</button>
    </form>
